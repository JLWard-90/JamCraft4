...
public class Malt 
{
    ...
    public float conv; //Conversion factor from kg to sugar as a fraction
    public string[] flavours; //Flavours
    public int quality; //A quality rating from 0 (rotten) to 10 (best malt ever)
    public int price;
    public Malt(string name, string type, int EBC, float conv, int quality, string[] flavours, int price)
    {
        this.name = name;
        this.type = type;
        this.EBC = EBC;
