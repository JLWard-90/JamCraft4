...
public class Hops
{
    ...
    public float IBUs; //international bitterness unitys
    public int quality; //between 0 and 10
    public int price; //price per unit
    public Hops(string name, string type, string[] flavours, float IBUs, int quality, int price) //Constructor for Hops class
    {
        this.name = name;
        this.type = type;
